...
public class HomeController {
    ...
    @FXML
    private void changeToFaktury() throws IOException {
        //System.out.println("changeToFaktury");
        Stage current_stage = (Stage) FakturyPane.getScene().getWindow();
        FXMLLoader faktury = new FXMLLoader(Main.class.getResource("/fxml/Faktury.fxml"));
        Scene sceneFaktury = new Scene(faktury.load(), 750, 500);
        current_stage.setScene(sceneFaktury);
        current_stage.setTitle("Faktury.fxml");
    }
    @FXML

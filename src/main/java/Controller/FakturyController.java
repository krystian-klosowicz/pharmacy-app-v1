...
public class FakturyController {
    ...
    private void switchToAdd() throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/fxml/FakturyDodaj.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 750, 900);
        home_stage.setTitle("FakturyDodaj.fxml");
    ...
    private void switchToEdit() throws IOException {
        //nowy stage, otwieranie FakturyDodaj.fxml
        Stage home_stage = new Stage();
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/fxml/FakturyEdytuj.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 750, 900);
        home_stage.setTitle("FakturyEdytuj.fxml");
        home_stage.setScene(scene);
        home_stage.show();
